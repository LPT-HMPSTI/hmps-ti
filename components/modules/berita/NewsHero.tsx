...
/**
 * Komponen banner header portal berita & agenda HMPSTI SWU.
 * Menyediakan kolom pencarian kata kunci dan tombol tab kategori interaktif.
 */
    ...
    <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#121520] p-6 sm:p-10 backdrop-blur-xl shadow-2xl">
      <div className="relative z-10 space-y-3">
        <Badge variant="cyan" tilt="left">
          PORTAL BERITA & AGENDA {currentPeriod}
        </Badge>
        <h1 className="text-3xl font-extrabold text-white sm:text-5xl">
          Portal Berita & <span className="text-[#1DB954]">Agenda HMPSTI</span>
        </h1>
        <p className="text-xs sm:text-sm text-slate-300 max-w-2xl leading-relaxed">
          Pusat informasi resmi terkini mengenai kegiatan, workshop, agenda himpunan, dan pengumuman akademik Teknik Informatika STMIK Widya Utama.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 pt-4">
          <div className="relative flex-1 max-w-md">
            <input
              ...
              placeholder="Cari berita atau agenda event..."
